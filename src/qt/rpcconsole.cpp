...
ui->startupTime->setVisible(false);
ui->lastBlockTime->setVisible(false);        setNumConnections(model->getNumConnections());
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Bighancoin RPC console.") + "<br>" +
