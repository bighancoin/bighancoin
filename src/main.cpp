...
// Copyright (c) 2013 The Bighancoin developers
...
uint256 hashGenesisBlock("00000b54dd530812f91bef6fef0c8c3141b68f61dad60434d7522df3ea30b8a9");
static const unsigned int timeGenesisBlock = 1466899688;
...
const string strMessageMagic = "Bighancoin Signed Message:\n";
...
static const int64 nTargetSpacing = 60; // 30
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    if(pindexLast->nHeight >= 7205 && pindexLast->nHeight < 10000)
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000f010371c2bd488019119058c31661a772cf53434a7ed073504cfb798bcb");
    }
...
*/
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("12472e91c6e7a33e53379f1ec0bc51d0cce7fc82e2b1773f2cd076d0145dbeb4"));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("BighancoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("BighancoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("BighancoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("Bighancoin-miner");
    ...
    try { loop {
        ...
        printf("Running BighancoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("BighancoinMiner terminated\n");
        throw;
    }
}
